...
public class MinecartCraftingTable extends AbstractMinecartContainer
{
	...
	public static enum CraftingTableType
	{
		...
		BA_AZALEA(VCTBlocks.BA_AZALEA_CRAFTING_TABLE.get()),
		BA_FLOWERING_AZALEA(VCTBlocks.BA_FLOWERING_AZALEA_CRAFTING_TABLE.get()),
		COCONUT(VCTBlocks.COCONUT_CRAFTING_TABLE.get()),
