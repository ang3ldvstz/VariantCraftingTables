...
public class VCTItems
{
	...
	public static final RegistryObject<Item> RUE_CHERRY_CRAFTING_TABLE_MINECART = ITEMS.register("rue_cherry_crafting_table_minecart", () -> new CraftingTableMinecartItem(new Item.Properties().stacksTo(1), CraftingTableType.RUE_CHERRY));
