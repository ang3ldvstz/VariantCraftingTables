...
{	
    ...
    // Pyromancy
 	...
 	public static final RegistryObject<Block> RUE_CHERRY_CRAFTING_TABLE = BLOCKS.register("rue_cherry_crafting_table", () -> new VCTCraftingTableBlock(Block.Properties.of().instrument(NoteBlockInstrument.BASS).strength(2.5F).sound(SoundType.WOOD))); 	 	
