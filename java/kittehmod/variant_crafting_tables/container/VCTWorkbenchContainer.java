...
public class VCTWorkbenchContainer extends WorkbenchContainer
{
	...
	public VCTWorkbenchContainer(int id, PlayerInventory playerInventoryIn, Block blockIn) {
		this(id, playerInventoryIn, IWorldPosCallable.NULL, blockIn);
	}

	public VCTWorkbenchContainer(int id, PlayerInventory playerInventoryIn, IWorldPosCallable worldPosIn, Block blockIn) {
